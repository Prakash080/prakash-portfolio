...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Ambient glows */}
      <div className="absolute top-0 left-1/4 w-150 h-100 bg-cyan-500/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute top-1/4 right-1/4 w-100 h-100 bg-indigo-500/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex items-center gap-3 flex-wrap">
              <span className="text-zinc-600 text-sm">Currently building with</span>
              <div className="relative overflow-hidden h-7 w-36">
                <motion.span
                  key={skillIndex}
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-2">
              {SKILLS.map((skill, i) => {
                ...
                return (
                  <motion.span
                    key={skill}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-mono font-medium cursor-default select-none"
                    style={{
                      background: isActive ? "rgba(110,231,247,0.12)" : "rgba(110,231,247,0.06)",
                      border: `1px solid ${isActive ? "rgba(110,231,247,0.45)" : "rgba(110,231,247,0.15)"}`,
                      color: isActive ? "#6ee7f7" : "#6ee7f7cc",
                      boxShadow: isActive ? "0 0 12px rgba(110,231,247,0.25), 0 0 3px rgba(110,231,247,0.15)" : "none",
                  ...
                  >
                    <span
                      className="w-1.5 h-1.5 rounded-full shrink-0 bg-cyan-400"
